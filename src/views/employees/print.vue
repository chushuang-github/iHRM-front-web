<template>
  <div class="dashboard-container" id="myPrint" ref="exportPDF">
    <div class="app-container">
      <el-card>
        ...
        <el-row type="flex" justify="end">
          ...
          <el-button size="small" type="primary" @click="savePDF">pdf下载</el-button>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    savePDF() {
      this.$PDFSave(this.$refs.exportPDF, "基本信息")
    }
  }
}
</script>
